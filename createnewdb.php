...
?>
 <head>
  <title>Elementech - Create New Database</title>
</head>
<style type="text/css">
body{
...
<body>
  ...
  <div class="content">
    ...
    if(isset($_POST['base_url'])){ //check if base_url is set or not.
      ...
      error_reporting(0);
      // Create connection
      $conn = mysqli_connect($_POST['database_host'], $_POST['database_username'], $_POST['database_password']);
      ...
      if (mysqli_connect_error()) {
        ...
        $query = "CREATE DATABASE `Elementech_".$_POST['database_name']."`;";
        if($result = $conn->multi_query($query)){
		  echo "<div class='container'>";
		  echo "<div class='box'>";
		  echo "<h1>Database</h1>";
		  echo "<h2>Check the status</h2>";
		  echo "<li>Database `Elementech_".$_POST['database_name']."` - Created successfully.</li>";
		  echo '<li>The database created successfully, Please go to the install page. <strong><a href="install.php">Quick Link</a></strong></li>';
		  echo "</div>";
		  echo "</div>";
        } else {
		  echo "<div class='container'>";
		  ...
		  echo "<h1>Errors</h1>";
		  echo "<h2>Check the status</h2>";
          die( "<li>ERROR: Could not able to execute $query. " . mysqli_error($conn) . "</li>");
		  echo "</div>";
		  echo "</div>";
        }
      }
	...
	<ul>
	<li>Base Url: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="base_url" style="width:300px" value="<?php echo preg_replace('/createnewdb\.php/','',"http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>"/> <span class="info"></span></li>
	<li>Database Host: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="database_host" style="width:300px" value="localhost"/> <span class="info"></span></li>
 	<li>Databases in use: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <select type="text" name="db_in_use" style="width:300px">
		<?php 
	...
	<li>Database Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="database_name" style="width:300px" value=""/> <span class="info"></span></li>
