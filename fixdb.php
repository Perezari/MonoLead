...
?>
 <head>
  <title>Elementech - Fix Database</title>
</head>
<style type="text/css">
body{
  ...
  <div class="content">
    ...
    if(isset($_POST['base_url'])){ //check if base_url is set or not.
      ...
      if (mysqli_connect_error()) {
        ...
        $query = "delete from task order by id desc limit 1;";
		$query.= "INSERT INTO `tasklog` (`user_id`, `task_id`, `user_name`, `Name`) VALUES ('SR000', 'LAST TASK', 'Administrator', 'FIX');";
        if($result = $conn->multi_query($query)){
		  echo "<div class='container'>";
		  echo "<div class='box'>";
		  echo "<h1>Database Fixed</h1>";
		  echo "<h2>Check the status</h2>";
		  echo "<li>Database - Fixed successfully.</li>";
	...
	<ul>
	<li>Base Url: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="base_url" style="width:300px" value="<?php echo preg_replace('/fixdb\.php/','',"http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"); ?>"/> <span class="info"></span></li>
