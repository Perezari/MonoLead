...
var w2utils = (function () {
    ...
    var obj = {
        ...
        settings : {
            ...
            "fulldays"          : ["יום שני", "יום שלישי", "יום רביעי", "יום חמישי", "יום שישי", "יום שבת", "יום ראשון"],
	...
	function isPhone(val) {
		var Phone = /^(?:(?:(\+?972|\(\+?972\)|\+?\(972\))(?:\s|\.|-)?([1-9]\d?))|(0[23489]{1})|(0[57]{1}[0-9]))(?:\s|\.|-)?([^0\D]{1}\d{2}(?:\s|\.|-)?\d{4})$/;
...
(function () {
    ...
    w2grid.prototype = {
        ...
        buttons: {
            ...
            'search-go': { type: 'check',  id: 'w2ui-search-advanced', caption: w2utils.lang('Search'), hint: w2utils.lang('Open search fields'), icon: 'w2ui-icon-search' },
        ...
        stateRestore: function (newState) {
            ...
            if ($.isPlainObject(newState)) {
				...
				if(!obj.url) { //this line is new by ez
                setTimeout(function () {
                ...
                switch (field.type) {
                    ...
                    case 'email':
                        if (this.record[field.name] && !w2utils.isEmail(this.record[field.name])) {
                            errors.push({ field: field, error: w2utils.lang('Email address in not valid') });
                        }
						break;
					case 'phone':
                        if (this.record[field.name] && !w2utils.isPhone(this.record[field.name])) {
                            errors.push({ field: field, error: w2utils.lang('Not a valid phone') });
                        }
                        break;
                    case 'checkbox':
                        // convert true/false
