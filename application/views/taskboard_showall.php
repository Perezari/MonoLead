				...
				<div style="width:100%;padding:5px" >
					...
					<div class="dialog-content">
						...
						foreach ($_TASK_DATA[$key] as $key2 => $value2) { ?>
							<div class="dialog-content-task">
								...
								<div style="float:right" >
									...
									<div class="progress-box" style="width:200px;overflow:hidden">
										<div class="progress-fill" style="width:<?php echo $value2['progress']*2; ?>px;background-color:hsl(<?php echo $value2['progress']; ?>, 100%, 50%)"></div>
									</div>
							...
							<div style="float:right;margin-right:20px;font-size:10px">
								<span style="float:left;margin-right:5px;" class="ticket-lbl" ><b>Last update: <?php echo $this->time_elapsed_string($value2['update_date']); ?></b></span>
							</div>
							<div style="padding-left:5px;float:left">
								<span class="label label-info">	<?php echo $value2['name'];?> </span>
