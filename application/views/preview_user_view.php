    ...
    <div id="form_user" style="width: 750px;height:80%;margin-top:50px">
      <div class="w2ui-page page-0">
        ...
        <div style="width: 500px; float: left; margin-right: 0px;">
          <div style="padding: 3px; font-weight: bold; color: #777;">What 's my job?</div>
          <div class="w2ui-group" style="text-align:left;height: 30px;padding:0px">
            <div class="w2ui-field w2ui-span4">
              <label>Position</label>
              <div class="<?php echo $_USER_GROUP['icon']; ?>" style="width:30px;height:20px;padding-left:30px;line-height:20px">
          ...
          <div class="w2ui-group" style="text-align:left; padding:0px; overflow-y: auto; height: 105px;">
        ...
        <div style="padding: 3px; font-weight: bold; color: #777;">User image</div>
