...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        if (isset($auth_users[$_POST['fm_usr']]) && $_POST['fm_pwd'] === $auth_users[$_POST['fm_usr']]) {
            ...
            fm_set_msg(''.$_POST['fm_usr'].' You are logged in');
...
<head>
<meta charset="utf-8">
<title>Elementech File Manager</title>
<style>
...
{
    ?>
<p class="center"><small><a href="application/views/main.php">Return to dashboard page in elementech</a></small></p>
</div>
<script>
