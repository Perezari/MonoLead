...
<head>
	...
	<title>Elementech Blog Installer</title>
...
<body>
	...
	<div id="container">
		...
		<footer>
			<p><a href="http://nibbleblog.com">Elementech <?php echo NIBBLEBLOG_VERSION ?> "<?php echo NIBBLEBLOG_NAME ?>"</a> | Copyright (2009 - 2013) + GPL v3 | Developed by Ari Perez | <?php echo Html::link( array('content'=>$_LANG['EXPERT_MODE'], 'href'=>'./install.php?expert=true&language='.$_GET['language']) ) ?></p>
		</footer>
